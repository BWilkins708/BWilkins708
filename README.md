...
- 💻 Skills/tech:
- Frontend Development: HTML5, CSS3, JavaScript, React, TypeScript, Tailwind CSS, SVG.js
- Backend Development: Python, C#, PHP
- Databases: SQL, MySQL, Microsoft SQL Server, Microsoft Access, FileMaker
- Tools & Version Control: Git, GitHub, Bitbucket, Jira, Jenkins
- Methodologies: Agile, Scrum, Pair Programming, Story Mapping
- Cloud Platforms: AWS (CLF-C02 Certified), Microsoft Azure (AZ-900 Certified)
